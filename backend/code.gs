...
function doPost(e) {
  try {
    ...
    switch (action) {
      ...
      case "getQuanLyKhuVuc": responseData = getQuanLyKhuVuc(requestData); break;
      case "adminLuuKhuVuc": responseData = adminLuuKhuVuc(requestData); break;
      case "adminDoiTrangThaiKhuVuc": responseData = adminDoiTrangThaiKhuVuc(requestData); break;
      case "adminXoaKhuVuc": responseData = adminXoaKhuVuc(requestData); break;
      case "getCauHinhDiemDacBiet": responseData = getCauHinhDiemDacBiet(requestData); break;
      case "adminLuuCauHinhDiemDacBiet": responseData = adminLuuCauHinhDiemDacBiet(requestData); break;
