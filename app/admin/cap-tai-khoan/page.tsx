...
export default function capTaiKhoanPage() {
  useEffect(() => {
        ...
        { initCapTaiKhoanVisibility(); loadCapTaiKhoan(); };
        ...
        <div className="p-4 space-y-5 text-sm">
          ...
          <div className="bg-white border rounded-xl p-3">
            <div className="flex justify-between items-center mb-3">
              <h3 className="font-bold text-gray-800 text-xs uppercase">2. Danh sách tài khoản đã cấp</h3>
              <button onClick={() => { (window as any).loadDanhSachTaiKhoanAdmin(); }} className="text-xs text-blue-600 underline">Tải danh sách</button>
            </div>
            <div id="listTaiKhoanAdmin" className="space-y-2"></div>
          </div>
        </div>
      </div>
    </div></section></main>;
